package com.marvin.lop.widgets;
...
public class AbScrollView extends ScrollView {
    ...
    /**
     * 根据XML生成视图工作完成，该函数在生成视图的最后调用，在所有子视图添加完成之后，
     * 即使子类覆盖了onFinishInflate方法，也应该调用父类的方法， 使得该方法得以执行
     */
    @Override
    protected void onFinishInflate() {
        // TODO: 2016/3/29 有问题，下面调用父类的方法在原来的代码中没有，需要处理一下
